    ...
    <div class="main-panel">
      <div class="content-wrapper">
        <div class="page-header">
          <h3 class="page-title" style="color:skyblue;"> Scheme Details </h3>
        </div>
        <!--Undu-->
                 ...
                 <table id="" class="table table-striped table-bordered table-responsive w-100">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="../Application/index.php?cid=<?php echo $row['sc_id']; ?>" ><i class="btn btn-primary">Apply</i></a></td>
