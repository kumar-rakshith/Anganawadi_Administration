                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $row['month'] ?></td>
                                                     ...
                                                     <!-- <td><a href="updatecenter.php?crid=<?php echo $row['rid']; ?>" ><i class="mdi mdi-grease-pencil">Update</a></i><td>
                                          
                                                      <td><a href="DeleteCenter.php?crid=<?php echo $row['rid']; ?>" ><i class="mdi mdi-delete">delete</a></i><td>
                                                      -->
                                                    </tr>
                                                    <?php  } ?>
                                                  </tbody>
