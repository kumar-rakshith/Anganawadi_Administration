    ...
    <div class="main-panel">
      <div class="content-wrapper">
        <div class="page-header">
          <h3 class="page-title" style="color:skyblue;"> Vaccination Report</h3>
        </div>
        <!--Undu-->
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            ...
            <div class="card-body">
              <!--Undu-->
              <h4 class="card-title">View Vaccination Report</h4>
              <p class="card-description"><code>All Vaccination Report</code>
              </p>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <!-- <td><a href="updatevaccination.php?sid=<?php echo $row['v_id']; ?>" >Update</a></td> -->
                    ...
                    <form class="" action="Controller/generate_report.php" method="POST">
                      <div class="row">
                          ...
                          <div class="col-md-2 ml-auto">
                            <input type="text" name="filename" class="form-control" value="tbl_vaccination" hidden>
