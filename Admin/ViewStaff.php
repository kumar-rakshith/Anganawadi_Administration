      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title" style="color:skyblue;">Staff Details</h3>
          </div>
         <!--Undu-->
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-description"><code>All Staff Details</code>
                  ...
                  <!-- <button type="submit" class="btn btn-rounded btn-success" style="margin-right:70%;" onclick="AddScheme()">View Staff</button>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="Updatestaff.php?sid=<?php echo $row['staff_id']; ?>"><i class="btn btn-primary">Update</a></td> 
                      <td><a id="<?php echo $row['staff_id']; ?>" onclick="validation(this.id);"><i class="btn btn-danger">Delete</a></td>
  ...
  <script type="text/javascript">
    ...
    function validation(rowid)
    {
        ...
        if (result.value) { 
            ...
            window.location.href = "deletestaff.php?sid="+rowid;
