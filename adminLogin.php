<?php
    ...
    $admin=new Admin();
    $admin->isLogged('admin', 'Admin/index');
    ...
    if (isset($_POST['forgot_btn'])) {
        ...
        $res = $control->check_valid_admin($email);
        if ($res) {
            $id = $res['id'];
            ...
            if(($previous_otp==0) || ($current_time>=$check_time)){
                ...
                $res = $control->update_otp_admin($id,$otp,$current_time);
                // echo "YESSSSS";
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 offset-lg-4">
              <div id="firstBox" class="auth-form-light text-left p-5 shadow mb-5 bg-white">
                ...
                <form class="m-t-md active" method="post" action="Controller/admincontroller.php" id="login_form" <?php if($shownext==1){echo 'hidden=""';} ?> >
                ...
                <div class="login-box" id="change_password">
                  ...
                  <form class="m-t-md" method="post" action="Controller/password_controller.php" id="login_form4">
                      ...
                      <div class="form-group" id="con_passblock" style="display:none">
                        ...
                        <button type="submit" id="cng_pswd_admin" name="cng_pswd_admin" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" >Change Password</button>
                    </form>
                </div>
              </div>
            </div>
            <div class="col-lg-1" style="margin-top: auto; margin-bottom: auto;">
              <h2 class="vertical-text">ADMIN</h2>
            </div>         
          </div>
        </div>
      </div>
