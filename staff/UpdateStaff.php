                ...
                if(isset($_POST["update"]))
                {
                  if(isset($_FILES['image']['name']))
                  {
                    ...
                    {           
                      ...
                      $qry=mysqli_query($con,"UPDATE `tbl_staff` SET `staff_fname`='$ufname',`staff_lname`='$ulname',`gender`='$ugender',`image`='$final_file',`contact`='$ucontact',`email`='$uemail',`address`='$uadd' WHERE `staff_id`='$uid'") or die(mysqli_error($con));
                      if($qry)
                      {
