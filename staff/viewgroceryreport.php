    ...
    <div class="main-panel">
      <div class="content-wrapper">
        <div class="page-header">
          <h3 class="page-title" style="color:skyblue;"> Grocery Report</h3>
        </div>
        <!--Undu-->
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            ...
            <div class="card-body">
              <!--Undu-->
              <h4 class="card-title">View Grocery Report</h4>
              <p class="card-description"><code>All Grocery Report</code>
              </p>
                      ...
                      <tr>
                        ...
                        <!-- 
                                         <td><a href="updatecenter.php?crid=<?php echo $row['cid']; ?>" ><i class="btn btn-primary">Update</a></i></td>
                                          ...
                                          <td><a href="Deletegrocery.php?gid=<?php echo $row['gid']; ?>" ><i class="btn btn-danger">delete</a></i></td>
                                        -->
                                      </tr>
                                      <?php  } ?>
                                    </tbody>
                    ...
                    <form class="" action="Controller/generate_report.php" method="POST">
                      <div class="row">
                          ...
                          <div class="col-md-2 ml-auto">
                            <input type="text" name="filename" class="form-control" value="tbl_grocery" hidden>
