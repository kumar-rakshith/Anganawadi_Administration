      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title" style="color:skyblue;"> Feedback </h3>
          </div>
          ...
          <div class="col-lg-10 offset-lg-1 grid-margin stretch-card">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-description"><code>All Feedback Details</code>
                </p>
                  ...
                  <table id="" class="table table-striped table-bordered table-responsive w-100">
                    ...
                    <tbody>
                      ...
                      include('connect.php');
                      $i=1;
                      $query=mysqli_query($con,"SELECT * FROM `tbl_feedback`") or die(mysqli_error($con));
