  ...
  <div class="container-fluid page-body-wrapper">
                  ...
                  <table id="" class="table table-striped table-bordered table-responsive w-100">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <!--<td><a href="updatecenter.php?crid=<?php echo $row['child_id']; ?>" ><i class="btn btn-primary">Update</a></i></td>
                        
                        <!-- <td><a href="Deletechild.php?child_id=<?php echo $row['child_id']; ?>" ><i class="btn btn-danger">delete</a></i></td> -->
                        <td><a id="<?php echo $row['child_id']; ?>" onclick="validation(this.id);"><i class="btn btn-danger">Delete</a></td>
    ...
    function validation(rowid)
    {
        ...
        if (result.value) { 
            ...
            window.location.href = "Deletechild.php?child_id="+rowid;
