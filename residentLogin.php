<?php
    ...
    $resident->isLogged('resident', 'Resident/index');
    ...
    if (isset($_POST['forgot_btn'])) {
        ...
        $res = $control->check_valid_resident($email);
        if ($res) {
            $id = $res['r_id'];
            ...
            if(($previous_otp==0) || ($current_time>=$check_time)){
                ...
                $res = $control->update_otp_resident($id,$otp,$current_time);
                // echo "YESSSSS";
...
<head>
    ...
    <style type="text/css">
        ...
        h2 { color: rgba(255, 255, 255, 0.4); font-family: 'Raleway',sans-serif; font-size: 32px; font-weight: 400; line-height: 46px; margin: 0 0 24px; text-align: center; text-transform: uppercase; }
    </style>
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 offset-lg-4">
              <div id="firstBox" class="auth-form-light text-left p-5 shadow mb-5 bg-white">
                ...
                <form class="m-t-md active" method="post" action="Controller/residentcontroller.php" id="login_form" <?php if($shownext==1){echo 'hidden=""';} ?> >
                ...
                <div class="login-box" id="change_password">
                  ...
                  <form class="m-t-md" method="post" action="Controller/password_controller.php" id="login_form4">
                      ...
                      <div class="form-group" id="con_passblock" style="display:none">
                        ...
                        <button type="submit" id="cng_pswd_res" name="cng_pswd_res" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" >Change Password</button>
                    </form>
                </div>
              </div>
            </div>
            <div class="col-lg-1" style="margin-top: auto; margin-bottom: auto;">
              <h2 class="vertical-text">RESIDENT</h2>
            </div>
          </div>
        </div>
      </div>
